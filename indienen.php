<?php
// ============================================================
// indienen.php — Formulier om een nieuwe grap in te dienen
// ============================================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (empty($gekozenCategorieen)) {
        $melding = 'Selecteer minstens één categorie!';

    } else {
        // --------------------------------------------------------
        // STAP 1: Sla de grap op in de tabel 'grappen'
        // (categorie is al gevalideerd hierboven)
        // --------------------------------------------------------
...
<head>
    ...
    <title>Grap indienen — Grappenopslag</title>
...
<body>
    ...
    <main class="formulier-wrapper">
        ...
        <form method="POST" action="indienen.php">
